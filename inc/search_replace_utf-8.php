...
function shopstat_getRegExps() {
  ...
  // Französisch
  if (defined('SPECIAL_CHAR_FR') && SPECIAL_CHAR_FR === true) {
    $sr_array_fr = array(  
  ...
  // Spanisch
  if (defined('SPECIAL_CHAR_ES') && SPECIAL_CHAR_ES === true) {
    $sr_array_es = array(  
      // Spanisch
  ...
  if (defined('SPECIAL_CHAR_PL') && SPECIAL_CHAR_PL === true) {
    $sr_array_pl = array(
      "'&#260;|Ą'i"           => 'A',
      "'&#261;|ą'i"           => 'a',
      "'&#280;|Ę'i"           => 'E',
  ...
  if (defined('SPECIAL_CHAR_CZ') && SPECIAL_CHAR_CZ === true) {
    $sr_array_cz = array(

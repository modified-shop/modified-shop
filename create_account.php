...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
  ...
  if ($error == false) {
    ...
    if ($check_email['total'] == 0) {
      ...
      // create templates
      $smarty->caching = 0;
      $html_mail = $smarty->fetch(Template::resolve('mail/' . $_SESSION['language'] . '/create_account_mail.html'));
      $txt_mail = $smarty->fetch(Template::resolve('mail/' . $_SESSION['language'] . '/create_account_mail.txt'));
...
$smarty->caching = 0;
$main_content = $smarty->fetch(Template::resolve('module/create_account.html'));

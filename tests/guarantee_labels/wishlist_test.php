...
// Aufruf nur die erste Position. Der Test bildet genau diese Reihenfolge nach, sonst prueft er
// eine Annahme statt den Kern. Die Hersteller holt der Puffer selbst zusammen, sobald er ein
// zweites Mal nachfragen muss.
...
ok('drei Hersteller mit hoechstens zwei Abfragen', $GLOBALS['queries'] <= 5, 'Abfragen: '.$GLOBALS['queries']);

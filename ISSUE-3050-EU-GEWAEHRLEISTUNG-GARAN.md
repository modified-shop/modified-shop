...
Ein Anhang wird nur archiviert, wenn seine `group_ids` die Kundengruppe der Bestellung einschliessen. Sonst ginge ein Dokument an eine Gruppe, die es im Shop nicht sehen darf. Die Moduldiagnose meldet solche Anhaenge zusaetzlich, weil eine einmal geprueft gespeicherte Markierung spaeter ungueltig werden kann.

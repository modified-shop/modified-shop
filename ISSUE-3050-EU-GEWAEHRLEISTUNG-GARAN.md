...
- Das Aufraeumen loescht ausschliesslich, schreibt nie und fragt den Katalog gar nicht:
  ...
  - Auch kein Attribut mehr: Jede Zeile ist verwaist, alle werden entfernt.
...
- Zaehlen hilft in diesem letzten Fall nicht. Wird das einzige Downloadattribut einer Position geloescht, die auch ein koerperliches traegt, bleiben ein Attribut und eine Zeile uebrig. Das ist von einer unberuehrten Position nicht zu unterscheiden und zugleich der haeufigste Fall, um den es hier geht. Die Meldung erscheint deshalb immer, sobald Zeilen und Attribute nebeneinander bestehen bleiben, und nennt als Grund die nicht ueberpruefbare Zuordnung.
...
- Eine verwaiste Zeile ist der harmlose Fehler, ein entzogenes Downloadrecht nicht. Fuer GARAN bleibt die Folge bestehen: Eine Position mit einer verbliebenen Zeile gilt weiterhin als digital, der Gewaehrleistungshinweis entfaellt dort also, wo er haette erscheinen muessen. Das trifft den Ablauf `koerperliches und digitales Attribut, digitales geloescht` und damit keinen Randfall. Die Meldung macht ihn sichtbar, loest ihn aber nicht.
...
- Das einzige Downloadattribut einer Position entfernen, die auch ein koerperliches Attribut traegt; es bleiben ein Attribut und eine Zeile, es wird nichts geloescht und die Warnung erscheint trotzdem.
...
Solange das so ist, kann das Aufraeumen einer geloeschten Downloadzeile nicht in allen Faellen greifen: Sobald der Position noch Attribute verbleiben, laesst sich nicht feststellen, welche Zeile zu welchem gehoert, und es wird keine entfernt. Der Umsetzungsstand waehlt bewusst diesen Fehler, weil die Alternative Downloadrechte von Kunden entziehen oder erfinden wuerde.

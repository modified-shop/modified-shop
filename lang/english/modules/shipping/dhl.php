...
define('MODULE_SHIPPING_DHL_UNDEFINED_RATE', 'Shipping costs cannot be calculated for the moment');
...
define('MODULE_SHIPPING_DHL_HANDLING_DESC' , 'Handling fee for this shipping method');

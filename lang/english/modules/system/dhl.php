...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_DHL_ENDORSEMENT_TITLE', 'Endorsement');
  define('MODULE_DHL_ENDORSEMENT_DESC', 'How should international parcels be handled if they cannot be delivered?');

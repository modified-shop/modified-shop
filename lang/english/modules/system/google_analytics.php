...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_GOOGLE_ANALYTICS_ADS_ID_DESC', 'If you want to use Google Ads (AdWords) Remarketing, enter your Google Ads (AdWords) ID in the format "AW-XXXXXXXXXX".');

  define('MODULE_GOOGLE_ANALYTICS_ADS_CONVERSION_ID_TITLE', 'Google Ads (AdWords) Conversion ID');
  define('MODULE_GOOGLE_ANALYTICS_ADS_CONVERSION_ID_DESC', 'If you want to use Google Ads (AdWords) Conversion Tracking, enter your Google Ads (AdWords) Conversion ID in the format "AW-XXXXXXXXXX/xxx".');

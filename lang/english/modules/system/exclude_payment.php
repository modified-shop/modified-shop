...
define('MODULE_EXCLUDE_PAYMENT_TEXT_TITLE', 'Payment methods depends on the shipping');
...
for ($module_exclude_payment_i = 1; $module_exclude_payment_i <= MODULE_EXCLUDE_PAYMENT_NUMBER; $module_exclude_payment_i ++) {
  ...
  define('MODULE_EXCLUDE_PAYMENT_SHIPPING_'.$module_exclude_payment_i.'_DESC' , 'Select the delivery method when you want to exclude a payment method.');
  define('MODULE_EXCLUDE_PAYMENT_PAYMENT_'.$module_exclude_payment_i.'_TITLE' , $module_exclude_payment_i.'. payment method');

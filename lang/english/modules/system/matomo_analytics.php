...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_MATOMO_ANALYTICS_LOCAL_PATH_DESC' , 'Enter the path where Matomo was installed successfully. The complete path of the domain has to be given, but without "http://", e.g. "www.example.com/matomo".');
  ...
  define('MODULE_MATOMO_ANALYTICS_COUNT_ADMIN_DESC' , 'By activating this option, all page views of the administration users of the shop owner will be counted as well. This will falsify the visitor stats.');

<?php
  ...
  define('MODULE_COOKIE_CONSENT_EXTENDED_DESCRIPTION', '<strong><font color="red">ATTENTION:</font></strong> Please setup Cookie Consent configuration under "Configuration" -> <a href="'.((!defined('RUN_MODE_ADMIN') && function_exists('xtc_href_link')) ? xtc_href_link(FILENAME_COOKIE_CONSENT) : '#').'"><strong>"Cookie Consent"</strong></a>!');

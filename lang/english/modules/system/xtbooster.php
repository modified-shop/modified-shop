...
define('MODULE_XTBOOSTER_STATUS_DESC','Module status');
...
define('MODULE_XTBOOSTER_STDSITE_TITLE','Default Site');
define('MODULE_XTBOOSTER_STDSITE_DESC','');
define('MODULE_XTBOOSTER_STDCURRENCY_TITLE','Default Currency');
define('MODULE_XTBOOSTER_STDCURRENCY_DESC','');
define('MODULE_XTBOOSTER_STDPLZ_TITLE','Default location (PLZ)');
define('MODULE_XTBOOSTER_STDPLZ_DESC','');
define('MODULE_XTBOOSTER_STDSTANDORT_TITLE','Default location');

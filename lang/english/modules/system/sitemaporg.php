...
define('MODULE_SITEMAPORG_CHANGEFREQ_TITLE','Frequency');
define('MODULE_SITEMAPORG_CHANGEFREQ_DESC','The frequency the content is changed');
define('MODULE_SITEMAPORG_ROOT_TITLE', '<hr /><b>Installation in Shoproot ?</b>');
define('MODULE_SITEMAPORG_ROOT_DESC', 'Save the sitemap in the main directory ?');
...
define('MODULE_SITEMAPORG_GZIP_DESC', 'File is extended automatically');
...
define('MODULE_SITEMAPORG_YAHOO_DESC','Enter your Yahoo ID.');

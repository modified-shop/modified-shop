...
if (defined("MODULE_PAYMENT_BILLPAYPAYLATER_VISUAL_MODE") && constant("MODULE_PAYMENT_BILLPAYPAYLATER_VISUAL_MODE") === "RechnungPlus") {
    define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_TITLE', 'BillPay - RechnungPlus');
} else {
    define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_TITLE', 'BillPay - PayLater');
}
...
define('MODULE_PAYMENT_BILLPAYPAYLATER_TEXT_TITLE_RECHNUNG_PLUS', 'BillPay - RechnungPlus');
define('MODULE_PAYMENT_BILLPAY_OT_PAYLATER_TOTAL_RECHNUNG_PLUS', 'Total + RechnungPlus fee');

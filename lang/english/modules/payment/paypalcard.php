...
$lang_array = array(
  ...
  'MODULE_PAYMENT_PAYPALCARD_TEXT_INFO' => ((!defined('RUN_MODE_ADMIN') && function_exists('xtc_href_link')) ? '<img src="'.xtc_href_link(DIR_WS_ICONS.'paypal.png', '', 'SSL', false).'" />' : ''),
  ...
  'MODULE_PAYMENT_PAYPALCARD_STATUS_TITLE' => 'Enable PayPal',
  'MODULE_PAYMENT_PAYPALCARD_STATUS_DESC' => 'Do you want to accept PayPal payments?',
  ...
  'MODULE_PAYMENT_PAYPALCARD_TEXT_ERROR_MESSAGE' => 'PayPal payment has been canceled',
);

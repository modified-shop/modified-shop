...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_WORLDPAY_JUNIOR_TEXT_ADMIN_CONFIGURATION', '<b>WorldPay setup:</b> Enable the Payment Response and configure its password. Set the Payment Response URL to <code>https://&lt;wpdisplay item=&quot;MC_callback&quot;&gt;</code>. Set <i>Enable Shopper Response</i> to <b>No</b>. Set the Shopper Redirect URL to <code>&lt;wpdisplay item=&quot;MC_returnurl&quot;&gt;</code> and <i>Enable Shopper Redirect button</i> to <b>Yes</b> so the shopper returns directly to the shop checkout.<br><b>Important:</b> A temporary order without an authenticated WorldPay status is not deleted automatically. Check the payment in the WorldPay back office before cleaning up such an order manually.');

...
/* -----------------------------------------------------------------------------------------
  ...
  $lang_array = array(
    ...
    'MODULE_PAYMENT_EASYINVOICE_ZONE_DESC' => 'If a zone is chosen, the payment method will be valid for this zone only.',
    ...
    'MODULE_PAYMENT_EASYINVOICE_ORDER_STATUS_CANCEL_ID_TITLE' => 'Cancelled order status',
    'MODULE_PAYMENT_EASYINVOICE_ORDER_STATUS_CANCEL_ID_DESC' => 'Specify the order status for orders whose authorisation never arrived',
    ...
    'TEXT_EASYINVOICE_AUTHORIZATION_PENDING' => 'The authorisation was still pending when the order was placed. Please check the status of the transaction in the payment section of the order.',

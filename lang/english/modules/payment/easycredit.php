...
/* -----------------------------------------------------------------------------------------
  ...
  $lang_array = array(
    ...
    'MODULE_PAYMENT_EASYCREDIT_ORDER_STATUS_CANCEL_ID_TITLE' => 'Cancelled order status',
    'MODULE_PAYMENT_EASYCREDIT_ORDER_STATUS_CANCEL_ID_DESC' => 'Specify the order status for orders whose authorisation never arrived',
    ...
    'TEXT_EASYCREDIT_AUTHORIZATION_CONFLICT_FAILED' => 'The authorisation is no longer expected. The order status was set manually in the meantime and is left untouched.',

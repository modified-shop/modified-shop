...
define('TEXT_CONTENT_SUCCESSFULLY_SET', 'Site content authorizations successfully set.');
define('TEXT_CONTENT_SUCCESSFULLY_UNSET', 'Site content authorizations successfully removed.');

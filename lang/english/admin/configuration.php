...
define('SHOW_PAYMENT_INFORMATION_TITLE', 'Show payment informations?');
define('SHOW_PAYMENT_INFORMATION_DESC', 'Shall the payment informations be shown in the last step of the checkout?');
?>
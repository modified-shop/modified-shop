...
define('ATTRIBUTES_VALID_CHECK_DESC', 'Validate products with attributes?<br/><b>Note:</b> For extensions that expand the attributes such as text field, this check must be disabled.');
?>
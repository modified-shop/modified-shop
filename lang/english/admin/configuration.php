...
define('ENTRY_PASSWORD_MAX_LENGTH_TITLE' , 'Password (maximum)');
define('ENTRY_PASSWORD_MAX_LENGTH_DESC' , 'Maximum length of password');
...
define('MAX_DISPLAY_NEW_PRODUCTS_DESC' , 'Maximum number of new products to display in a category and "whats new" box');
define('MAX_DISPLAY_NEW_PRODUCTS_STARTPAGE_TITLE' , 'Number of products Startpage');
define('MAX_DISPLAY_NEW_PRODUCTS_STARTPAGE_DESC' , 'Maximum number of products to display as "TOP-products" on startpage');
...
define('DELETE_GUEST_ACCOUNT_DESC','Should guest accounts be deleted after placing orders? (Order data will be saved) Guest accounts are additionally cleaned up after the retention period set in "Delete Guest Accounts After X Days" by the "guest_account_maintenance" scheduled task (order data is preserved as well).');

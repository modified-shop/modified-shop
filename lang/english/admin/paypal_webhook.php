...
$lang_array = array(
  ...
  'TEXT_PAYPAL_WEBHOOK_INFO' => '<ul><li>No Webhooks available.</li><li>With Webhooks you receive updates for Payments and orders status</li><li>To use webhook, it is imperative that you have a valid SSL certificate.</li></ul>',

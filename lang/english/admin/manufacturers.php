...
define('TEXT_MANUFACTURERS_ADDRESS', 'Manufacturer Address');
define('TEXT_RESPONSIBLE_ADDRESS', 'Responsible Address');
...
define('TEXT_MANUFACTURERS_ADD_DESCRIPTION', 'Necessary Manufacturer description:');

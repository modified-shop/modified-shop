...
/* -----------------------------------------------------------------------------------------
  ...
  define('TEXT_EMAIL_ACTIVE_ERROR','An error occurred, this e-mail address has not been registered for the newsletter!');
  define('TEXT_EMAIL_DEL','E-Mail address was deleted successfully from newsletter database.');
  define('TEXT_EMAIL_DEL_ERROR','An Error occurred, E-Mail address has not been removed from database!');

...
/* -----------------------------------------------------------------------------------------
  ...
  define('TEXT_HEADING_TASKS_EASYCREDIT_TXSTATUS', 'Payment status easyCredit');
  define('TEXT_INFO_TASKS_EASYCREDIT_TXSTATUS', 'Pending easyCredit transactions are reconciled with the payment service');

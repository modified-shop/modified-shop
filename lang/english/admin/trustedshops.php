...
define('TEXT_PRODUCT_STICKER_API_INFO', 'With the product review API the reviews are imported into the store. For this it is necessary that a cronjob is created on URL '.HTTPS_SERVER.DIR_WS_CATALOG.'api/trustedshops/cronjob.php');

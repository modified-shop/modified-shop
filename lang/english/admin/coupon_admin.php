...
define('COUPON_MANUFACTURERS', 'Valid Manufacturers List');
...
define('COUPON_MANUFACTURERS_HELP', 'A comma separated list of Manufacturers IDs that this coupon can be used with, leave blank for no restrictions.');

...
define('TEXT_PAYPAL_CARTITEM','Artikel Anzahl');
...
define('STATUS_PENDING','Ausstehend');
define('STATUS_REFUNDED','Zur&uuml;ckgezahlt');
define('STATUS_REVERSED','Storniert');
define('STATUS_DENIED','Abgelehnt');
...
define('STATUS_VOIDED','Entwertet');

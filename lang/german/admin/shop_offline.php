...
define('SHOP_OFFLINE_ALLOWED_CUSTOMERS_GROUPS_TXT', '<b>Erlaubte Kundengruppen:</b><br />(f&uuml;r diese Kundengruppen ist der Shop weiterhin sichtbar)');
define('SHOP_OFFLINE_ALLOWED_CUSTOMERS_EMAILS_TXT', '<b>Erlaubte E-Mail-Adressen (kommagetrennt):</b> <br />(f&uuml;r Kunden mit diesen E-Mail-Adressen ist der Shop weiterhin sichtbar)');
?>
...
define('TEXT_BANNERS_REDIRECT', 'Banner Statistk:'); 
define('TEXT_BANNERS_REDIRECT_NOTE', 'Soll eine Statistik über die Klicks erstellt werden ? (keine direkte Verlinkung des URL-Ziel)'); 

...
define('SHOW_PAYMENT_INFORMATION_TITLE', 'Zahlungsinformationen anzeigen?');
define('SHOW_PAYMENT_INFORMATION_DESC', 'Sollen im letzten Schritt der Bestellung bereits die Zahlungsinformationen gezeigt werden?');
?>
...
define('STORE_PAGE_PARSE_TIME_LOG_DESC' , 'Hier den Speicherort/Dateiname eintragen, in dem die Berechnungszeit f&uuml;r den Seitenaufbau, sowie die Datenbank Abfragen gespeichert werden.<br/><strong>Achtung: Datei kann bei l&auml;ngerer Laufzeit sehr gro&szlig; werden!</strong>.<br/><br/>Standard-Datei "query.log":<br/><strong>Frontend:</strong> Berechnungszeit und Datenbank Abfragen im Frontend des Shops werden im Root-Verzeichnis in der Datei "<strong>query.log</strong>" gespeichert.<br/><strong>Administrationsbereich (Backend):</strong> Berechnungszeit und Datenbank Abfragen im Administrationsbereich des Shops werden automatisch in der Datei "<strong>admin/query.log</strong>" gespeichert.');
...
define('ACTIVATE_GIFT_SYSTEM_DESC','Gutscheinsystem aktivieren?<br/><br/><b>Hinweis: </b>Es m&uuml;ssen noch die Module ot_coupon und ot_gv <a href="'.xtc_href_link(FILENAME_MODULES, 'set=ordertotal').'"><b>hier</span></b></a> aktiviert werden.');
...
define('DISPLAY_BREADCRUMB_OPTION_DESC', 'model: In der Breadcrumb Navigation wird die Artikelnummer angezeigt, sofern sie vorhanden ist. Ansonsten Fallback auf auf Artikelname.<br />name: In der Breadcrumb Navigation wird der komplette Artikelname angezeigt angezeigt.');

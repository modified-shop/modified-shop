...
define('MAX_DISPLAY_NEW_PRODUCTS_DESC' , 'Maximum Anzahl an neuen Artikeln, die in den Kategorien und in der Box "Neue Artikel" angezeigt werden sollen.');
define('MAX_DISPLAY_PRODUCTS_STARTPAGE_TITLE' , 'Anzahl Artikel Startseite');
define('MAX_DISPLAY_PRODUCTS_STARTPAGE_DESC' , 'Maximum Anzahl an Artikeln, die als "TOP-Artikel" auf der Startseite angezeigt werden sollen.');
...
define('DELETE_GUEST_ACCOUNT_DESC','Sollen Gast-Konten nach erfolgter Bestellung gel&ouml;scht werden? (Bestelldaten bleiben erhalten) Gast-Konten werden zus&auml;tzlich nach Ablauf der unter "L&ouml;schen von Gast-Konten nach X Tagen" hinterlegten Frist &uuml;ber die geplante Aufgabe "guest_account_maintenance" bereinigt (Bestelldaten bleiben ebenfalls erhalten).');

define('DELETE_GUEST_ACCOUNT_DAYS_TITLE','L&ouml;schen von Gast-Konten nach X Tagen');
define('DELETE_GUEST_ACCOUNT_DAYS_DESC','Anzahl der Tage, nach denen Gast-Konten durch die geplante Aufgabe "guest_account_maintenance" gel&ouml;scht werden (Bestelldaten bleiben erhalten). Greift nur, wenn "L&ouml;schen von Gast-Konten" aktiviert ist.');

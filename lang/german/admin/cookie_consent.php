<?php
  ...
  define('TEXT_INFO_VALUE_COOKIES_DESC', 'Geben Sie den Namen des gesetzten Cookies an, der gel&ouml;scht werden soll. Mehrere Namen k&ouml;nnen getrennt durch Komma angegeben werden. Sie k&ouml;nnen auch nur die ersten Zeichen der Namen eingeben, diese d&uuml;rfen sich aber nicht mit Namen anderer Cookies &uuml;berschneiden um nicht die falschen Cookies zu l&ouml;schen.');

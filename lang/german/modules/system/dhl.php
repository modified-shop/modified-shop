...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_DHL_ACCOUNT_DESC', 'Account ID im Format ISO2:ID getrennt durch Komma (standard WORLD:01). Sollte die Warenpost eine abweichende ID haben, dann mit Zusatz PK (Paket) oder WP (Warenpost). Beispiel: WORLD:01PK,WORLD:02WP');

...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_GOOGLE_ANALYTICS_TAG_ID_DESC', 'Tragen Sie hier Ihre Google Analytics TAG ID im Format "G-XXXXXXXXXX" oder "UA-XXXXXXXXXX" (für migrierte Google Analytics Properties) ein.');

...
for ($module_shipping_chp_i = 1; $module_shipping_chp_i <= 10; $module_shipping_chp_i ++) {
  ...
  define('MODULE_SHIPPING_CHRONOPOST_COUNTRIES_'.$module_shipping_chp_i.'_DESC' , 'Kommagetrennte Liste von den 2-stelligen ISO country codes der Zone '.$module_shipping_chp_i.' (WORLD eintragen f&uuml;r den Rest der Welt.).');

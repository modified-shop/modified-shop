...
$lang_array = array(
  ...
  'MODULE_PAYMENT_PAYPALPRZELEWY_TEXT_INFO' => ((!defined('RUN_MODE_ADMIN') && function_exists('xtc_href_link')) ? '<img src="'.xtc_href_link(DIR_WS_ICONS.'paypal.png', '', 'SSL', false).'" />' : ''),
  ...
  'MODULE_PAYMENT_PAYPALPRZELEWY_ALLOWED_DESC' => 'Geben Sie <b>einzeln</b> die Zonen an, welche f&uuml;r dieses Modul erlaubt sein sollen. (z.B. AT,DE (wenn leer, werden alle Zonen erlaubt))',
  'MODULE_PAYMENT_PAYPALPRZELEWY_STATUS_TITLE' => 'PayPal Sepa aktivieren',
  'MODULE_PAYMENT_PAYPALPRZELEWY_STATUS_DESC' => 'M&ouml;chten Sie Zahlungen per PayPal Sepa akzeptieren?',
  ...
  'MODULE_PAYMENT_PAYPALPRZELEWY_TEXT_ERROR_MESSAGE' => 'PayPal Zahlung wurde abgebrochen',  
);

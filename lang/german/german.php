...
define('NAVBAR_TITLE_1_CHECKOUT_PROCESSING', 'Kasse');
define('NAVBAR_TITLE_2_CHECKOUT_PROCESSING', 'Verarbeitung');
define('TEXT_CHECKOUT_PROCESSING_TITLE', 'Ihre Bestellung wird verarbeitet');
define('TEXT_CHECKOUT_PROCESSING_MESSAGE', 'Bitte schlie&szlig;en Sie dieses Fenster nicht und laden Sie die Seite nicht neu.');
define('TEXT_CHECKOUT_PROCESSING_WAIT', 'Sie werden automatisch weitergeleitet, sobald die Bestellung abgeschlossen ist.');
...
define('TEXT_COUPON_HELP_NAME', 'Gutschein-/Couponbezeichnung: %s');
define('TEXT_COUPON_HELP_SPECIALS', 'Der Coupon kann nicht auf Sonderangebote angewendet werden.');
define('TEXT_COUPON_HELP_FIXED', 'Der Gutschein-/Couponwert betr&auml;gt %s ');
define('TEXT_COUPON_HELP_MINORDER', 'Der Mindestbestellwert betr&auml;gt %s ');
...
define('TEXT_COUPON_HELP_MANUFACTURERS', 'Hersteller Einschr&auml;nkung');

...
/* -----------------------------------------------------------------------------------------
  ...
  if (isset ($_GET['action']) && ($_GET['action'] == 'success')) {
    ...
    $smarty->assign('INPUT_NAME', xtc_draw_input_field('name', ((isset($name)) ? $name : ''), 'autocomplete="name"'));
    $smarty->assign('INPUT_COMPANY', xtc_draw_input_field('company', ((isset($company)) ? $company : ''), 'autocomplete="organization"'));

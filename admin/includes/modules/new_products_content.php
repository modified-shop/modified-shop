      ...
      <div class="main" style="margin:15px 5px 2px 5px"><b><?php echo $lng_image . '&nbsp;' . HEADING_PRODUCTS_CONTENT; ?></b></div>
        <table width="100%" cellspacing="0" cellpadding="5" border="0" style="padding: 0 2px 0 4px;">
          <tr class="dataTableHeadingRow">
            <td class="dataTableHeadingContent txta-c" nowrap width="2%" ><?php echo TABLE_HEADING_PRODUCTS_CONTENT_ID; ?></td>
            <td class="dataTableHeadingContent txta-c" nowrap width="2%" >&nbsp;</td>
            <td class="dataTableHeadingContent txta-c" nowrap width="20%" ><?php echo TABLE_HEADING_CONTENT_NAME; ?></td>
            <td class="dataTableHeadingContent txta-c" nowrap width="28%" ><?php echo TABLE_HEADING_CONTENT_FILE; ?></td>
            <td class="dataTableHeadingContent txta-c" nowrap width="1%" ><?php echo TABLE_HEADING_CONTENT_FILESIZE; ?></td>
            <td class="dataTableHeadingContent txta-c" nowrap align="middle" width="15%" ><?php echo TABLE_HEADING_CONTENT_LINK; ?></td>
            <td class="dataTableHeadingContent txta-c" nowrap width="5%" ><?php echo TABLE_HEADING_CONTENT_HITS; ?></td>
            <td class="dataTableHeadingContent txta-r" nowrap width="5%" ><?php echo TABLE_HEADING_CONTENT_SORT; ?></td>
            <td class="dataTableHeadingContent txta-c" nowrap width="22%" ><?php echo TABLE_HEADING_CONTENT_ACTION; ?></td>
          </tr>
          <?php
          while ($content_array = xtc_db_fetch_array($content_query)) {
            ...
            ?>
              <td class="dataTableContent txta-c"><?php echo  $content_array['content_id']; ?> </td>
              ...
              <td class="dataTableContent"><?php echo $content_array['content_name']; ?></td>
              <td class="dataTableContent"><?php echo $content_array['content_file'] . '&nbsp;'; ?></td>
              <td class="dataTableContent txta-c"><?php echo xtc_filesize($content_array['content_file']); ?></td>
              <td class="dataTableContent txta-c">
                <?php
              ...
              <td class="dataTableContent txta-c"><?php echo $content_array['content_read']; ?></td>
              <td class="dataTableContent txta-r"><?php echo $content_array['sort_order']; ?></td>

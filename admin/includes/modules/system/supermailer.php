...
class supermailer {
  ...
  function install() {
    ...
    xtc_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, use_function, date_added) VALUES ('MODULE_SUPERMAILER_EMAIL_ADDRESS', '',  '6', '1', 'xtc_cfg_input_email_language;MODULE_SUPERMAILER_EMAIL_ADDRESS', now())");

...
$config = array(
    ...
    */
    ...
    'editable_text_file_exts'                 => array( 'txt', 'xml' ),
    ...
    'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'psd', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff'), //Files
    ...
    * URL upload
    *******************/
    // upload.php resolves the host first and only fetches public addresses,
    // so this stays on; set it to false to switch the feature off entirely
    'url_upload'                             => true,

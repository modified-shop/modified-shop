    ...
    <?php
      ...
      while ($memo_values = xtc_db_fetch_array($memo_query)) {
        ...
        <table style="width:100%">
          ...
          <tr>        
            <td><a style="text-decoration:none;" href="<?php echo xtc_href_link(FILENAME_CUSTOMERS, 'cID=' . (int)$_GET['cID'] . '&action=edit&special=remove_memo&mID=' . $memo_values['memo_id']); ?>" class="button" onclick="return confirmLink('<?php echo DELETE_ENTRY; ?>', '', this)"><?php echo BUTTON_DELETE; ?></a></td> 
          </tr>
        </table>
      <?php
      }

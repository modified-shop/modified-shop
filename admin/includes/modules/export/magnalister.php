...
class magnalister {
  ...
  public function __construct() {
    ...
    $this->enabled = ((MODULE_MAGNA_STATUS == 'True') ? true : false);
	}
  ...
  function check() {
    if (!isset($this->_check)) {
      $check_query = xtc_db_query("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_MAGNA_STATUS'");

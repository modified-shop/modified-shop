...
define('DB_VERSION', 'MOD_2.0.7.1'); // ToDo before release!

define('PROJECT_MAJOR_VERSION', '2');
define('PROJECT_MINOR_VERSION', '0.7.1');
define('PROJECT_REVISION', '14605'); // ToDo before release!
define('PROJECT_SERVICEPACK_VERSION', ''); // currently not in use since new version numbers
define('PROJECT_RELEASE_DATE', '2022-06-30'); // ToDo before release!

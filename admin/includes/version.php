...
define('DB_VERSION', 'MOD_3.1.0'); // ToDo before release!

define('PROJECT_MAJOR_VERSION', '3');
define('PROJECT_MINOR_VERSION', '1.0');
define('PROJECT_REVISION', '16069'); // ToDo before release!
define('PROJECT_SERVICEPACK_VERSION', ''); // currently not in use since new version numbers
define('PROJECT_RELEASE_DATE', '2024-07-15'); // ToDo before release!

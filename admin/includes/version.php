...
define('DB_VERSION', 'MOD_2.0.2.2'); // ToDo before release!

define('PROJECT_MAJOR_VERSION', '2');
define('PROJECT_MINOR_VERSION', '0.2.2');
define('PROJECT_REVISION', '10690'); // ToDo before release!
define('PROJECT_SERVICEPACK_VERSION', ''); // currently not in use since new version numbers
define('PROJECT_RELEASE_DATE', '2017-04-13'); // ToDo before release!

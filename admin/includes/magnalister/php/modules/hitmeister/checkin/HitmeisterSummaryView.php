...
/**
 * TODO:
 *  * Shippingtime speichern. Entweder in prepare tabelle, oder wenn da nicht vorhanden in selection (in processAdditionalPost()).
 *  * Selbe beim Auslesen in getAdditionalItemCells()
 *
 */

...
//###############################//
   ...
   */
    ...
    function insert_product($products_data, $dest_category_id, $action = 'insert') {
      ...
      $products_data['products_quantity'] = xtc_convert_value($products_data['products_quantity']);
      $products_data['products_vpe'] = xtc_convert_value( $products_data['products_vpe']);

...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            autoWidth: false,             // set width by Objekt using innerWidth()
            minWidth: 0,
            addWidth: 0,
            maxAddWidth: 0,
            consoleLog: false
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    var O = this;
                    var elmName = O.E.attr('name').toLowerCase();
                    elmName = elmName.replace(/\[/g, '_');
                    elmName = elmName.replace(/\]/g, '');
                    ...
                    if (! O.E.closest(".SumoSelect").length ) {
                        if (settings.consoleLog) console.log("has no parent with the class .SumoSelect");
                        O.E.wrap('<div class="SumoSelect '+ elmName +'">');
                    }

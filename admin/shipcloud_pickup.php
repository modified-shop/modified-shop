            ...
            <td width="100%">
              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td class="pageHeading"><?php echo HEADING_SHIPCLOUD_PICKUP; ?></td>
                </tr>
                <tr>
                ...
                while ($carriers = xtc_db_fetch_array($carriers_query)) {
                  ...
                  if (xtc_db_num_rows($shipcloud_query) > 0) {
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                      ...
                      <tr class="dataTableHeadingRow">
                        <td class="dataTableHeadingContent"><?php echo '<input type="checkbox" name="'.strtolower($carriers['carrier_name']).'" onClick="selectAll(document.getElementsByName(\'sc_'.strtolower($carriers['carrier_name']).'[]\'), \''.strtolower($carriers['carrier_name']).'\');" /> '.TABLE_HEADING_EDIT; ?></td>
                    ...
                    <div style="text-align: right; padding:5px 2px; margin-bottom:10px;">

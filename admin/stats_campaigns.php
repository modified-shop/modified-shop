              ...
              <tr>
                ...
                <td class="menuBoxHeading">
                  <?php 
                    ...
                    echo '<span class="select_w80">'.xtc_draw_pull_down_menu('startD', $day_array, $day).'</span>';
              ...
              <tr>
                <td class="menuBoxHeading">
                  <?php 
                    ...
                    echo '<span class="select_w80">'.xtc_draw_pull_down_menu('endD', $day_array, $day).'</span>';

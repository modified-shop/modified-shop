  ...
  if (xtc_not_null($action)) {
    switch ($action) {
      ...
      case 'deltempcache':
        ...
        file_put_contents(Template::path('stylesheet.min.css'), '');
        file_put_contents(Template::path('css/tpl_plugins.min.css'), '');
        file_put_contents(Template::path('javascript/tpl_plugins.min.js'), '');

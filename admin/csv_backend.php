...
<body>
    ...
    <tr>
      ...
      <td class="boxCenter">
        ...
        <?php
          ...
          echo '
         <tr>
          <td class="dataTableConfig col-left"><b>'.constant(strtoupper($configuration['configuration_key'].'_TITLE')).'</b></td>
  ...
  ';
      ...
      <div class="clear mrg5"><?php echo '<input type="submit" class="button" onclick="this.blur();" value="' . BUTTON_SAVE . '"/>'; ?></div>
      </form>
      </div>
      <?php
  if (isset($import))

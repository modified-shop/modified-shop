            ...
            <?php
              ...
              switch ($action) {
                case 'new':
                  ...
                  $contents[] = array('text' => '<br />' . TEXT_INFO_CUSTOMERS_STATUS_REVIEWS_STATUS_INTRO . '<br />' . ENTRY_CUSTOMERS_STATUS_REVIEWS_STATUS . ' ' . xtc_draw_pull_down_menu('customers_status_reviews_status', $customers_status_read_reviews_array, $cInfo->customers_status_reviews_status));

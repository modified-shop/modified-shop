                                ...
                                if($admin_access['whos_online'] == 1) {
                                  ...
                                  <td style="background: #F9F0F1; border: 1px solid #b40076;" height="200" valign="top">&nbsp;<em><font color="#7691A2"><?php echo TABLE_CAPTION_USERS_ONLINE_HINT; ?></font></em>
                                    <table border="0" width="98%" cellspacing="0" cellpadding="0">
                                      ...
                                      <?php
                                        $whos_online_query = xtc_db_query("select customer_id, full_name, ip_address, time_entry, time_last_click, last_page_url, session_id from " . TABLE_WHOS_ONLINE ." order by time_last_click desc LIMIT ".MAX_DISPLAY_SEARCH_RESULTS);

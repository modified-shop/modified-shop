...
$payment_block = $module_smarty->fetch(Template::resolve('module/checkout_payment_block.html'));
...
$main_content = $smarty->fetch(Template::resolve('module/checkout_payment.html'));

<?php
  ...
  if ($lang[1] == 'de') {
    // German definitions
    define ('TITLE_UPGRADE','<br /><strong><h1>modified-Datenbank Upgradevorgang</h1></strong>');
    ...
    define('TEXT_TITLE','modified Datenbankupgrade');
    ...
    define('REDIRECTED_FROM_INSTALLER','<strong>Ihre bereits bestehende Version von modified muss gegebenenfalls noch auf das neueste Datenbank-Schema aktualisiert werden!</strong>');
    ...
    // English definitions
    define ('TITLE_UPGRADE','<br /><strong><h1>modified database upgrade process</h1></strong>');
    ...
    define('TEXT_TITLE','modified database upgrade');
    ...
    define('REDIRECTED_FROM_INSTALLER','<strong>Your existing version of modified might have to be upgraded to the newest database schema first!</strong>');

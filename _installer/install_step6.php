    ...
    */
    ...
    if ($error == false) {
      ...
      if ($zone_setup == 'yes') {
        ...
        xtc_db_query("INSERT INTO tax_class (tax_class_id, tax_class_title, tax_class_description, last_modified, date_added) VALUES (2, '" . convert_utf8('ermäßigter Steuersatz') . "', '', NULL, now())");

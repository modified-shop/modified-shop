<?php
  ...
  define('TEXT_DB_UPGRADE','<strong>Nur Datenbank Upgrade des bereits installierten modified Shops durchf&uuml;hren!</strong>');
  // BOF - web28 - 2010.12.13 - NEW db-upgrade
  ...
  define('TEXT_WELCOME_INDEX','<b>Willkommen zu modified</b><br /><br />modified ist eine Open-Source e-commerce L&ouml;sung, die st&auml;ndig vom modified Team und einer grossen Gemeinschaft weiterentwickelt wird.<br /> Seine out-of-the-box Installation erlaubt es dem Shop-Besitzer seinen Online-Shop mit einem Minimum an Aufwand und Kosten zu installieren, zu betreiben und zu verwalten.<br /><br />modified ist auf jedem System lauff&auml;hig, welches eine PHP Umgebung (ab PHP 5.0) und MySQL zur Verf&uuml;gung stellt, wie zum Beispiel Linux, Solaris, BSD, und Microsoft Windows.<br /><br />modified ist ein OpenSource-Projekt &ndash; wir stecken jede Menge Arbeit und Freizeit in dieses Projekt und w&uuml;rden uns daher &uuml;ber eine Spende als kleine Anerkennung freuen.');
  ...
  ');
  define('TEXT_WELCOME_FINISHED','<b>modified Installation erfolgreich!</b><br /><br />Der Installer hat nun die Grundfunktionen Ihres Shops eingerichtet. Melden Sie sich im Catalog mit Ihrem Admin-Account an und wechseln in den Adminbereich, um die komplette Konfiguration Ihres Shops vorzunehmen.');

  // install_step1.php
  define('TITLE_CUSTOM_SETTINGS','Installations Optionen');
  define('TEXT_IMPORT_DB','modified Datenbank Installation');
  define('TEXT_IMPORT_DB_LONG','Installiert die modified Datenbankstruktur mit den ben&ouml;tigten Tabellen. <b>(Zwingend bei Erstinstallation! Bestehende Tabellen werden dabei geleert!)</b>');
  ...
  define('TEXT_USERNAME_LONG','Der Benutzername, der zum konnektieren der Datenbank ben&ouml;tigt wird, wie zum Beispiel <i>mysql_10</i>.<br /><br />Bemerkung: Wenn die modified Datenbank Importiert werden soll (wenn oben ausgew&auml;hlt), muss der Benutzer CREATE und DROP Rechte f&uuml;r die Datenbank haben. Sollten hier Probleme auftreten, kann Ihnen Ihr Provider weiterhelfen.');
  ...
  define('TEXT_WS_XTC','Webserver "modified" Verzeichnis');
  define('TEXT_WS_XTC_LONG','Das Verzeichnis, in das der Shop geladen wurde, relativ zum Webserver Root Verzeichnis, bspw. <b>/modified/</b>.<br /><br />Webserver Root Verzeichnis + Webserver "modified" Verzeichnis ergeben den vollst&auml;ndigen Pfad zum Shop.');
  define('TEXT_WS_ADMIN','Webserver Admin Verzeichnis');
  define('TEXT_WS_ADMIN_LONG','Das Verzeichnis, in welchem sich die Admin-Werkzeuge Ihres Shops befinden (vom Webserver root Verzeichnis), beispielsweise <i>/home/myname/public_html<b>/modified/admin/</b></i>.');
  define('TEXT_WS_CATALOG','WWW Catalog Verzeichnis');
  define('TEXT_WS_CATALOG_LONG','Das virtuelle Verzeichnis, in dem sich der modified Shop befindet, relativ zum HTTP Server, bspw. <b>/</b> oder <b>/modified/</b>.<br /><br />HTTP Server + WWW Catalog Verzeichnis ergeben die Shop-URL.');
  define('TEXT_WS_ADMINTOOL','WWW Admin Verzeichnis');
  define('TEXT_WS_ADMINTOOL_LONG','Das virtuelle Verzeichnis, in dem sich die modified Admin-Module befinden, beispielsweise <i>http://www.Ihre-Domain.de<b>/modified/admin/</b></i>');
  //BOF WEBSERVER INFO
  ...
  // install_step5.php
  define('TEXT_WS_CONFIGURATION_SUCCESS','<strong>modified</strong> Webserver Konfiguration war erfolgreich');
  ...
  define('TITLE_ZONE_CONFIG_NOTE','*Hinweis; modified kann die Zonen automatisch aufsetzten, sofern Sich Ihr Shop in der EU befindet.');
  ...
  // install_fnished.php
  define('TEXT_SHOP_CONFIG_SUCCESS','<strong>modified</strong> Shop Konfiguration war erfolgreich');
  define('TEXT_TEAM','Vielen Dank, dass Sie sich f&uuml;r die modified eCommerce Shopsoftware entschieden haben. Besuchen Sie uns auf der <a href="http://www.modified-shop.org">modified Supportseite</a>.<br /><br />Alles Gute und viel Erfolg w&uuml;nscht Ihnen das gesamte modified Team.<br /><br />Wenn Sie uns unterst&uuml;tzen wollen, w&uuml;rden wir uns &uuml;ber eine kleine Spende freuen.<br />');

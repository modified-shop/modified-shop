...
/* -----------------------------------------------------------------------------------------
  ...
  $db_type = get_mysql_type();
  $db_charset = ((isset($new_db_charset)) ? $new_db_charset : ((defined('DB_SERVER_CHARSET')) ? DB_SERVER_CHARSET : 'utf8'));
  $db_engine = ((isset($new_db_engine)) ? $new_db_engine : ((defined('DB_SERVER_ENGINE')) ? DB_SERVER_ENGINE : 'MyISAM'));
  $db_pconnect = USE_PCONNECT;

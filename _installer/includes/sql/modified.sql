...
INSERT INTO content_manager VALUES (19, 0, 0, '', 2, 'Gutscheine', 'Gutscheine - Fragen und Antworten', '<p><strong>Gutscheine kaufen </strong></p>\r\n<p>Gutscheine kˆnnen, falls sie im Shop angeboten werden, wie normale Artikel gekauft werden. Sobald Sie einen Gutschein gekauft haben und dieser nach erfolgreicher Zahlung freigeschaltet wurde, erscheint der Betrag unter Ihrem Warenkorb. Nun kˆnnen Sie ¸ber den Link " Gutschein versenden " den gew¸nschten Betrag per E-Mail versenden.</p>\r\n<p><strong>Wie man Gutscheine versendet</strong></p>\r\n<p>Um einen Gutschein zu versenden, klicken Sie bitte auf den Link "Gutschein versenden" in Ihrem Einkaufskorb. Um einen Gutschein zu versenden, benˆtigen wir folgende Angaben von Ihnen: Vor- und Nachname des Empf‰ngers. Eine g¸ltige E-Mail Adresse des Empf‰ngers. Den gew¸nschten Betrag (Sie kˆnnen auch Teilbetr‰ge Ihres Guthabens versenden). Eine kurze Nachricht an den Empf‰nger. Bitte ¸berpr¸fen Sie Ihre Angaben noch einmal vor dem Versenden. Sie haben vor dem Versenden jederzeit die Mˆglichkeit Ihre Angaben zu korrigieren.</p>\r\n<p><strong>Mit Gutscheinen einkaufen.</strong></p>\r\n<p>Sobald Sie ¸ber ein Guthaben verf¸gen, kˆnnen Sie dieses zum Bezahlen Ihrer Bestellung verwenden. W‰hrend des Bestellvorganges haben Sie die Mˆglichkeit Ihr Guthaben einzulˆsen. Falls das Guthaben unter dem Warenwert liegt m¸ssen Sie Ihre bevorzugte Zahlungsweise f¸r den Differenzbetrag w‰hlen. ‹bersteigt Ihr Guthaben den Warenwert, steht Ihnen das Restguthaben selbstverst‰ndlich f¸r Ihre n‰chste Bestellung zur Verf¸gung.</p>\r\n<p><strong>Gutscheine verbuchen. </strong></p>\r\n<p>Wenn Sie einen Gutschein per E-Mail erhalten haben, kˆnnen Sie den Betrag wie folgt verbuchen:<br />1. Klicken Sie auf den in der E-Mail angegebenen Link. Falls Sie noch nicht ¸ber ein persˆnliches Kundenkonto verf¸gen, haben Sie die Mˆglichkeit ein Konto zu erˆffnen.<br />2. Nachdem Sie ein Produkt in den Warenkorb gelegt haben, kˆnnen Sie dort Ihren Gutscheincode eingeben.</p>\r\n<p><strong>Falls es zu Problemen kommen sollte:</strong></p>\r\n<p>Falls es wider Erwarten zu Problemen mit einem Gutschein kommen sollte, kontaktieren Sie uns bitte per E-Mail: you@yourdomain.com. Bitte beschreiben Sie mˆglichst genau das Problem, wichtige Angaben sind unter anderem: Ihre Kundennummer, der Gutscheincode, Fehlermeldungen des Systems sowie der von Ihnen benutzte Browser (z.B. "Internet Explorer 6" oder "Firefox 1.5").</p>', 0, 1, '', 0, 6, 1, '', '', '', '', '1', 0, NOW(), NULL);

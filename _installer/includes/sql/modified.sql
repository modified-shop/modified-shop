...
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'SHOW_SHIPPING_TITLE', 'standard', 7, 10, NULL, NOW(), NULL, 'xtc_cfg_select_option(array(\'standard\', \'title\', \'custom\'),');
INSERT INTO configuration (configuration_id, configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'CUSTOM_SHIPPING_TITLE', '', 7, 11, NULL, NOW(), NULL, 'xtc_cfg_input_email_language;CUSTOM_SHIPPING_TITLE');

...
/* -----------------------------------------------------------------------------------------
  ...
  $unlink_file = array(
    ...
    DIR_ADMIN.'includes/modules/kcfinder/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/cache/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/conf/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/core/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/doc/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/integration/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/lang/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/lib/.htaccess',
    DIR_ADMIN.'includes/modules/kcfinder/themes/dark/img/files/big/..png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/dark/img/files/big/.image.png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/dark/img/files/small/..png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/dark/img/files/small/.image.png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/default/img/files/big/..png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/default/img/files/big/.image.png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/default/img/files/small/..png',
    DIR_ADMIN.'includes/modules/kcfinder/themes/default/img/files/small/.image.png',
    DIR_ADMIN.'includes/modules/kcfinder/tpl/.htaccess',
    ...
    DIR_ADMIN.'includes/safeterms/css/main.css',
    DIR_ADMIN.'includes/safeterms/images/logo.png',
    DIR_ADMIN.'includes/safeterms/check_apikey.php',
    DIR_ADMIN.'includes/safeterms/error_first_valid.php',
    DIR_ADMIN.'includes/safeterms/first_valid.php',
    DIR_ADMIN.'includes/safeterms/functions.php',
    DIR_ADMIN.'includes/safeterms/module_status.php',
    DIR_ADMIN.'includes/safeterms/new_customer.php',
    DIR_ADMIN.'includes/safeterms/overview.php',
    DIR_ADMIN.'includes/safeterms/set_apikey.php',
    DIR_ADMIN.'includes/safeterms/talkto.php',
    DIR_ADMIN.'includes/safeterms/update.php',
    ...
    'api/easymarketing/includes/auth.php',
    'api/easymarketing/includes/config.php',
    'api/easymarketing/includes/functions.php',
    'api/easymarketing/bestseller.php',
    'api/easymarketing/categories.php',
    'api/easymarketing/conversion_tracker.php',
    'api/easymarketing/products.php',
    'api/findologic/autocomplete.php',
    'api/findologic/findologic.php',
    'api/findologic/includes/functions.php',
    ...
    'includes/external/findologic/findologic_config.inc.php',
    'includes/external/findologic/findologic_listing.php',
    ...
    'includes/external/paypal/lib/Psr/Test/LoggerInterfaceTest.php',
    'includes/external/paypal/lib/Psr/Test/TestLogger.php',
    'includes/external/paypal/lib/Psr/AbstractLogger.php',
    'includes/external/paypal/lib/Psr/InvalidArgumentException.php',
    'includes/external/paypal/lib/Psr/LoggerAwareInterface.php',
    'includes/external/paypal/lib/Psr/LoggerAwareTrait.php',
    'includes/external/paypal/lib/Psr/LoggerInterface.php',
    'includes/external/paypal/lib/Psr/LoggerTrait.php',
    'includes/external/paypal/lib/Psr/LogLevel.php',
    'includes/external/paypal/lib/Psr/NullLogger.php',

...
<script type="text/javascript">//<![CDATA[
        $(document).ready(function () {
            $('<div title="<?php echo ML_TEMU_SHIPPINGLABEL_DOWNLOAD_TITLE ?>"><?php echo ML_TEMU_SHIPPINGLABEL_OVERVIEW_POPUP_AFTERCONFIRM_INFOCONTENT ?><a class="ml-downloadshippinglabel" target="_blank" href="<?php echo $this->getDownloadLink() ?>"></a></div>').jDialog({
                buttons: [
                    {
                        text: "DOWNLOAD",
                        click: function () {

<?php
  class ot_billpay_fee {
    ...
    function addFee() {
        if ($_SESSION['payment'] == 'billpay' || $_POST['payment'] == 'billpay') {
            if($this->_checkFeeGroup(0)===2)
                return !$_SESSION['billpay_b2b']; // not B2B
            else
    ...
    {
      return array(
        'MODULE_ORDER_TOTAL_'.$this->_paymentIdentifier.'_FEE_STATUS',
...
// TODO: it can be refactored to this:
/*
...
class ot_billpaypaylater_fee extends BillpayOT
{
    var $_paymentIdentifier = billpayBase::PAYMENT_METHOD_PAY_LATER;
}
*/

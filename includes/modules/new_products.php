...
if (!$module_smarty->is_cached(Template::resolve('module/new_products.html'), $cache_id) || !$cache) {
...
$module = $module_smarty->fetch(Template::resolve('module/new_products.html'), $cache_id);

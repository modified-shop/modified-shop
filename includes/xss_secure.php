...
//############  KONFIGURATION ##############//
defined('XSS_SEND_LOG') OR define('XSS_SEND_LOG', false); //default: false
defined('XSS_WRITE_LOG') OR define('XSS_WRITE_LOG', true); //default: true
defined('XSS_BLACKLIST') OR define('XSS_BLACKLIST', true); //default: true
defined('XSS_BLACKLIST_TIME') OR define('XSS_BLACKLIST_TIME', 3600); // time to block IP in seconds. default: 3600
...
$ssl_proxy = '';
if (xtc_is_trusted_proxy($_SERVER['REMOTE_ADDR'] ?? '')

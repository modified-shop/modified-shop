...
/* -----------------------------------------------------------------------------------------
  ...
  if (function_exists('guarantee_labels_active') && guarantee_labels_active()) {
    ...
    if (guarantee_labels_candidate($guarantee_labels_product, $guarantee_labels_product['products_id'])) {
      ...
      $module_content[$i]['GUARANTEE_LABEL'] = guarantee_labels_markup(guarantee_labels_product_label($guarantee_labels_product, $guarantee_labels_names, $guarantee_labels_product['products_id']));
    }
  }

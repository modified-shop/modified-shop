<?php
      ...
      )
  {
        ...
        ) 
    {
      ...
      $response = modified_api::request('product-reviews/v1/'.MODULE_SHOPVOTE_API.'/reviews?rs=RF5&limit=50&sd=false&lang='.$_SESSION['language_code'].'&sku='.preg_replace("'[\s]+'", '-', $product->data['products_model']));

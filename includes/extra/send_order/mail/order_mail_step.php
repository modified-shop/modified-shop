...
{
  $smarty->caching = 0;
  $html_mail = $smarty->fetch(Template::resolve('mail/' . $order->info['language'] . '/order_mail_step.html'));
  $txt_mail = $smarty->fetch(Template::resolve('mail/' . $order->info['language'] . '/order_mail_step.txt'));

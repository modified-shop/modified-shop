...
if (Template::findPath('css/general_bottom.css.php') !== null) {
  require Template::path('css/general_bottom.css.php');
}

// require theme based javascript
if (Template::findPath('javascript/general_bottom.js.php') !== null) {
  require Template::path('javascript/general_bottom.js.php');
}
